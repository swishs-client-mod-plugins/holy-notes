# IMPORTANT NOTICE
##  THIS VERSION WILL NOW BE FOREVER UNMAINTAINED
### Official development will continue at: https://github.com/swishs-client-mod-plugins/sperm-bank


Alternatively you can use [@SammChesse](https://github.com/SammCheese)'s fork https://github.com/SammCheese/holy-notes but powercord is a sinking ship so have fun while it lasts.
...
```
git clone https://github.com/swishs-client-mod-plugins/holy-notes
```
